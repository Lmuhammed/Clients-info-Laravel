...
class ClientController extends Controller
{
    ...
    $clients = Client::where('full_name', 'like', '%'.$search.'%')
                    ...
                    ->paginate(10);
     return view('app.Clients.client.index',compact('clients'));
    ...
    */
    ...
    function new_view(){
        return view('app.Clients.client.create');
    }
    ...
    function single_view(int $id)  {
        ...
        return view('app.Clients.client.view',compact('client'));
    }
    function edit(int $id) {
        $client=Client::find($id);
        $this->authorize('update', $client);
        return view('app.Clients.client.edit',compact('client')); 
    }
